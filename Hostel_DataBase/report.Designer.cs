namespace Hostel_DataBase
{
    partial class report
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.DataSet1 = new Hostel_DataBase.DataSet1();
            this.DataTable1BindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.DataTable1TableAdapter = new Hostel_DataBase.DataSet1TableAdapters.DataTable1TableAdapter();
            this.HostelDataSet = new Hostel_DataBase.HostelDataSet();
            this.AccountingBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.AccountingTableAdapter = new Hostel_DataBase.HostelDataSetTableAdapters.AccountingTableAdapter();
            ...
            reportDataSource1.Value = this.AccountingBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Hostel_DataBase.Report2.rdlc";
            this.reportViewer1.Location = new System.Drawing.Point(0, 0);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.Size = new System.Drawing.Size(754, 386);
            ...
            this.AccountingBindingSource.DataSource = this.HostelDataSet;
            // 
        ...
        private HostelDataSetTableAdapters.AccountingTableAdapter AccountingTableAdapter;
    }
}